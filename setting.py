...
volume_slider = ttk.Scale(root, from_=0, to=100, orient="horizontal", command=set_volume, length=200)
...
def toggle_theme():
    ...
    if is_dark:
        ...
        theme_button.config(text="화이트 모드")
    is_dark = not is_dark
...
key_setting_button.place(x=100, y=250)
